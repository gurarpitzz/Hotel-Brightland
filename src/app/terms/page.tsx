...
export const metadata = {
  ...
  description: "Comprehensive terms, conditions, and rules for guests staying at Brightland Hotel, Shimla.",
};
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-16 relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Link 
          href="/policy"
          className="inline-flex items-center text-brand-green-700 hover:text-brand-green-900 font-medium mb-8 transition-colors"
        >
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to High-Level Policies
        </Link>

        <div className="bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="bg-brand-green-900 px-8 py-10 text-center">
            <div className="inline-flex items-center justify-center p-3 bg-white/10 rounded-full mb-4">
              <FileText className="w-8 h-8 text-brand-yellow-100" />
            </div>
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-2 font-cursive tracking-wide">
              Terms & Conditions
            </h1>
            <p className="text-brand-green-100">
              Brightland Hotel Rules, Regulations & Guidelines Applicable to All Guests
            </p>
          </div>

          <div className="p-8 md:p-12">
            <div className="prose prose-brand max-w-none text-gray-600">
              <p className="mb-8 italic text-sm bg-brand-yellow-50 p-4 rounded-xl border border-brand-yellow-100 text-brand-green-900">
                Please read the following rules and regulations carefully. By making a booking, the guest is unconditionally deemed to accept all hotel rules and regulations.
              </p>
              ...
              <div className="mt-12 pt-8 border-t border-gray-100 text-center">
                <p className="font-bold text-brand-green-900 tracking-wider">MANAGEMENT</p>
                <p className="text-sm text-gray-500">Brightland Hotel, Shimla</p>
              </div>
            </div>
          </div>
        </div>
